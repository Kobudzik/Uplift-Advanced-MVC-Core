...
namespace Uplift.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        {
            return Json(new { data = _unitOfWork.OrderHeader.GetAll(o=>o.Status==StaticDetails.StatusSubmitted) });
        }
        

        public IActionResult GetAllApprovedOrders()
        {
            return Json(new { data = _unitOfWork.OrderHeader.GetAll(o => o.Status == StaticDetails.StatusApproved) });
        }
